...
exports.default = _default;
      ...
      if (typeof $488203 === 'function') {
        ...
        Object.assign($488203, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('svg',{staticClass:"gk-icon",attrs:{"aria-hidden":"true"}},[_c('use',{attrs:{"xlink:href":("#icon-" + _vm.name)}})])}
var staticRenderFns = []
...
exports.default = _default;
      ...
      if (typeof $cf9e65 === 'function') {
        ...
        Object.assign($cf9e65, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('button',{staticClass:"gk-button",class:( _obj = {}, _obj[("icon-" + _vm.iconPosition)] = true, _obj ),attrs:{"type":"button"},on:{"click":function($event){_vm.$emit('click')}}},[(_vm.icon && !_vm.loading)?_c('gk-icon',{attrs:{"name":_vm.icon}}):_vm._e(),_vm._v(" "),(_vm.loading)?_c('gk-icon',{staticClass:"loading",attrs:{"name":"reload"}}):_vm._e(),_vm._v(" "),_c('span',{staticClass:"icon-content"},[_vm._t("default")],2)],1)
var _obj;}
var staticRenderFns = []
...
describe('Button', function () {
  ...
  it('可以设置icon.', function () {
    ...
    expect(useElement.getAttribute('xlink:href')).to.equal('#icon-download');
    vm.$destroy();
  });
  it('可以设置loading.', function () {
    ...
    expect(useElements[0].getAttribute('xlink:href')).to.equal('#icon-reload');
    vm.$destroy();
  });
